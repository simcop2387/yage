 ...
 *
 * Inherit from TreeRoot and TreeNode to link arboolrary objects together into a
 * tree of arboolrary height and with any number of children at each level.
...
abstract class TreeItem
{
	...
	{	char[] result = .toString(index) ~ " " ~ formatString("%s ", this) ~ "\n";
